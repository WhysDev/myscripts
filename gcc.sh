...
ZIPNAME="SaranRomKak-Kernel-V21"
...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone() {
	echo " "
		msg "|| Cloning GCC ||"
		git clone --depth=1 https://github.com/pjorektneira/arm64-gcc -b arm64 gcc64
		git clone --depth=1 https://github.com/pjorektneira/arm32-gcc -b arm gcc32
		GCC64_DIR=$KERNEL_DIR/gcc64
		GCC32_DIR=$KERNEL_DIR/gcc32

	msg "|| Cloning Anykernel ||"
	git clone --depth 1 https://github.com/WhysDev/AnyKernel3-2
}

##------------------------------------------------------##

exports() {
	export KBUILD_BUILD_USER="SRK"
